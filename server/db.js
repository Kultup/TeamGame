...
const initialQuestions = [
  ...
  { id: 74, category: 'change', text: 'Заборонено використовувати слово "проблема". Замінюйте його на "можливість".' },
  { id: 75, category: 'change', text: 'Відтепер і до кінця гри кожну відповідь треба починати зі слова "Ми".' },
  { id: 76, category: 'change', text: 'Зміна ролей: на наступний раунд поміняйтеся ролями з колегою зліва.' },
  { id: 77, category: 'change', text: 'Бліц-раунд: наступні 3 питання обговорюються не більше 30 секунд кожне.' },
